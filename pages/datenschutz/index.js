export default function index() {
  return (
    <div className="container px-16">
      <h1 className="mb-16 text-4xl font-bold">Datenschutzerklärung</h1>
      <ol>
        <li>
          <h2 className="mb-8 text-2xl font-semibold lg:text-3xl">
            1. Datenschutz auf einen Blick
          </h2>
          <h3 className="mb-4 text-xl font-semibold">Allgemeine Hinweise</h3>
          <p className="mb-8">
        ...
        <li>
          ...
          <h3 className="mb-4 text-xl font-semibold">Datenschutz</h3>
          <p className="mb-2">
          ...
          <p className="mb-2">
            Ilona Lehmann<br></br> Von-Harsch-Str. 28<br></br> 79276 Reute
          </p>
          <p className="mb-2">
            Telefon: 015146601373<br></br> E-Mail:{" "}
            <a href="mailto:ilona@trau-momente.de">ilona@trau-momente.de</a>
          </p>
          <p className="mb-8">
          ...
          <h3 className="mb-4 text-xl font-semibold">Speicherdauer</h3>
          <p className="mb-8">
